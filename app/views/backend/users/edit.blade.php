...
<div class="form-group">
	<label class="control-label col-sm-2" for="account">Tài Khoản</label>
	<div class="col-sm-10">
...
<div class="form-group">
	...
	<div class="col-sm-10">
		{{Form::text('fullname', null, array('class'=>'form-control', 'id'=>'fullname','placeholder'=>'Tên đầy đủ'))}}
	</div>
</div>

<div class="form-group">
	<label class="control-label col-sm-2" for="description">Số Điện Thoại</label>
	<div class="col-sm-10">
