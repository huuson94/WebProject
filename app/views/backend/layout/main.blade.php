...
<html lang="en">
    <head>
        ...
        <script src="{{ asset('public/backend/dist/js/jquery-1.11.3.min.js') }}" type="text/javascript"></script>
        <script src="{{ asset('public/backend/dist/js/jquery-ui.min.js') }}" type="text/javascript"></script>
    </head>
